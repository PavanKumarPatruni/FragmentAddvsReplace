...
class ReplaceFragmentActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fab.setOnClickListener {
            ...
            when (count) {
                1 -> fragmentTransaction?.replace(R.id.fragmentContainer, OneFragment(), "fragments")
                2 -> fragmentTransaction?.replace(R.id.fragmentContainer, TwoFragment(), "fragments")
                3 -> fragmentTransaction?.replace(R.id.fragmentContainer, ThreeFragment(), "fragments")
                4 -> fragmentTransaction?.replace(R.id.fragmentContainer, FourFragment(), "fragments")
                else -> {
